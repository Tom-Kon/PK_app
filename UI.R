        ...
        sidebarPanel(
          ...
          tabsetPanel(
            ...
            tabPanel("General",
                     ...
                     sliderInput("P_eff",   "Permeation coefficient through the intestinal lumen (cm/s)", min = 1e-6, max = 1e-4, value = 1e-3, step = 1e-6),
                     sliderInput("Vd",   "Volume of distribution per kg (L/kg)", min = 0.1, max = 2, value = 1e-3, step = 1e-6),
